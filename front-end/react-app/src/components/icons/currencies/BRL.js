const BRL = ({ w, h }) => {
    return (
        <svg width={w} height={h} xmlns="http://www.w3.org/2000/svg" id="flag-icons-br" viewBox="0 0 640 480">
        <g strokeWidth="1pt">
            ...
            <path fill="#fff" fillRule="evenodd" d="M444.4 285.8a124.6 124.6 0 0 0 5.8-19.8c-67.8-59.5-143.3-90-238.7-83.7a124.5 124.5 0 0 0-8.5 20.9c113-10.8 196 39.2 241.4 82.6"/>
